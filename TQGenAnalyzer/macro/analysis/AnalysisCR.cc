...
void AnalysisCR::Loop(std::string mass,int tot,int trigger)
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	//electrons
        ...
        //mettere <0 per CR1a, CR2 e CR3, >0 per CR1b
	...
	//select TQ with highest vtx prob
        ...
        //mettere >0.05 per CR1b, CR2 e CR3, <0.05 per CR1a
...
*/	
   ...
   effrel_counter->GetXaxis()->SetBinLabel(14 , "ee mass > 4 GeV");
